...
public class ArrayUtil {
    ...
    /**
     * Returns true if x is in the array set
     *
     ...
     *
     * @param value value to look for
     * @param array ArrayList of values
     * @return count of occurrences of value
     */
     ...
     * @param out = element to remove from array
     ...
     * @param seek = element to search for
     ...
     *
     * @param xs = array 1
     * @param i start position in array xs
     * @param ys = array 2
     * @param j start position in array ys
     ...
     * Integers
     *
     * @param ints primitive array of int
     ...
     * of Doubles
     *
     * @param array primitive array of double
     ...
     *
     * @param matrix primitive 2D array of double (arrays of equal length)
     ...
     * cannot be created.
     *
     * @param <T> Type contained in matrix
     * @param matrix ArrayList of ArrayLists treated like 2D matrix
     * @param col column in matrix to retrieve
     * @param result 1D native array of T that will hold column result
     */
     ...
     * @param startIndex index in array
     * @param endIndex index in array not before startIndex
     * @return sub-array
     */
     ...
     * @param <T> should have equals implemented
