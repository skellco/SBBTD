...
public class CheckEachDirectionMultinetworkMsPacManController<T extends Network> extends NNDirectionalPacManController {
    ...
    public CheckEachDirectionMultinetworkMsPacManController(Genotype<T>[] genotypes, MsPacManControllerInputOutputMediator[] inputMediators, MsPacManModeSelector modeSelector) {
        super(genotypes[0].getPhenotype());
        // The main mediator cannot be null, since this causes problems with reset ... messy code
