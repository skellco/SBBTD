...
public abstract class Variable implements Serializable {
     ...
     * <code>Variable</code>. As not all objects belonging to asubclass of
     * <code>Variable</code> have a double value, a call to this method it is
     * considered a fatal error by default, and the program is terminated. Those
     * classes requiring this method must redefine it.
     */
     ...
     * considered a fatal error by default, and the program is terminated. Those
     * classes requiring this method mustredefine it.
     */
     ...
     * subclass of
     * <code>Variable</code> have a lower bound, a call to this method is
     * considered a fatal error by defaultm and the program is terminated. Those
