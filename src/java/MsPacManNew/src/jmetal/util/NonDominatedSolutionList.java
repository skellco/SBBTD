...
public class NonDominatedSolutionList extends SolutionSet {
    ...
    /**
     * Stores a
     * <code>Comparator</code> for dominance checking
     */
    private Comparator dominance_ = new DominanceComparator();
    /**
     * Stores a
     * <code>Comparator</code> for checking if two solutions are equal
     */
     ...
     * dominated or if an identical individual exists. The decision variables
     * can be null if the solution is read from a file; in that case, the
