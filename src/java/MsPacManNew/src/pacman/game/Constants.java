...
public final class Constants {
    ...
    public static int EDIBLE_TIME = 200;				//initial time a ghost is edible for (decreases as level number increases) 	
    ...
    public static int COMMON_LAIR_TIME = 40;			//time spend in lair after being eaten
//    public static final int LEVEL_LIMIT = 4000;				//time limit for a level
    ...
    public static int MAX_TIME = 100000;					//maximum time a game can be played for
    ...
    public static int NUM_LIVES = 1;					//total number of lives Ms Pac-Man has (current + NUM_LIVES-1 spares)
