// $ANTLR 2.7.2: "LogDrawParser.g" -> "LogDrawLexer.java"$
...
public class LogDrawLexer extends antlr.CharScanner implements LogDrawTokenTypes, TokenStream
 {
public LogDrawLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public LogDrawLexer(Reader in) {
	this(new CharBuffer(in));
}
public LogDrawLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public LogDrawLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable<ANTLRHashString,Integer>();
	literals.put(new ANTLRHashString("LINE", this), new Integer(16));
	literals.put(new ANTLRHashString("RECT", this), new Integer(17));
	literals.put(new ANTLRHashString("FILL", this), new Integer(8));
	literals.put(new ANTLRHashString("CIRC", this), new Integer(7));
	literals.put(new ANTLRHashString("TEXT", this), new Integer(18));
}
...
tryAgain:
	...
	public final void mNUMBER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		try {      // for error handling
			...
			if (((_tokenSet_4.member(LA(1))) && (_tokenSet_2.member(LA(2))))) {
				int _m48 = mark();
	...
	public final void mKEYWORD(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = KEYWORD;
		int _saveIndex;
	...
	private static final long[] mk_tokenSet_1() {
		long[] data = { 287948901175001088L, 0L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_3() {
		long[] data = { 70368744177664L, 0L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_7() {
		long[] data = { 0L, 134217726L, 0L, 0L, 0L};
		return data;
	}
