...
public class Trainer implements SoccerTypes
{
	...
	try {
	    ...
	    System.err.println( "Unable to write World State queue: " + queueFile );
	}
    }
...
//		   	 System.out.print("ETA");
	...
	try {
		...
		if ( args[ i ].equals( "-host" ) ) {
		    ...
		    dumpDir = args[i + 1];
                ...
                else if ( args[ i ].equals( "-taskAdjust" ) ) {
                    taskAdjust = Double.parseDouble( args[ i + 1 ] );
                }
		else {
	...
	{	task = new ShootGoalTask( sp, ws, cmd, launchMonitor,
				      ...
				      kwyFile, taskType, startEpisode, taskAdjust );
	}
