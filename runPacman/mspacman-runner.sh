...
../build/release/cpp/mspacmanSBBAgent/mspacmanSBBAgent -s $rSeed -p $rSeed -L 1 -O 5 -f 3 1> sbb.$rSeed.std 2> sbb.$rSeed.err &


elif [ $mode -eq 1 ]; then
#from scratch pillscore task
../build/release/cpp/mspacmanSBBAgent/mspacmanSBBAgent -s $rSeed -p $rSeed -L 1 -O 5 -f 2 1> sbb.$rSeed.std 2> sbb.$rSeed.err &

elif [ $mode -eq 2 ]; then
#pickup with new level
../build/release/cpp/mspacmanSBBAgent/mspacmanSBBAgent -s $rSeed -p $rSeed -L 2 -O 5 -f 1 -H -C 0 -t 3 -l 0  1> sbb.$rSeed.std 2> sbb.$rSeed.err &
