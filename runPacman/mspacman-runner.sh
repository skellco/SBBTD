...
#from scratch
#../build/release/cpp/mspacmanSBBAgent/mspacmanSBBAgent -s $r -p $r -O 5 -f 2 1> sbb.$r.std 2> sbb.$r.err &
...
../build/release/cpp/mspacmanSBBAgent/mspacmanSBBAgent -s $r -f 1 -O 5 -H -C 0 -t 3 -l 0  1> sbb.$r.std 2> sbb.$r.err &
